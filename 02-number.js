...
let n2 = Number(5); //  number 단위 함수를 이용한 생성
...
// Casting
// 자바 스크립트는 문자열로 전달 받은 수치 데이터를 Number로 변환해야 하는 경우가 많다
console.log("========== Casting");
...
let n4 = parseInt("abcd1234");  //  숫자로 변환할 수 없는 형태의 캐스팅
console.log(n4, "is", typeof n4);   //  NaN -> number 이지만, 산술연산이 불가한 수치
